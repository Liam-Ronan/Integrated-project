<?php
  require_once 'classes/DBConnector.php';
    ...
    try {
        ...
        $category = get::byId('types', $_GET['id']);


        $smallTechStories = Get::byCategoryOrderBy('health', 'published_date DESC', 2);
        $smallCultureStories = Get::byCategoryOrderBy('culture', 'published_date DESC', 2);
...
<div class="container">
        ...
        <div class="leftSide width-8">
            <div class="width-8">
                ...
                <div class="type width-8">
                    <h1><?= $category->name?> - Category</h1>
                </div>
                
                <div class="description width-6">
