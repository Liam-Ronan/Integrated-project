<?php
  require_once 'classes/DBConnector.php';
    ...
    try {
        ...
        $smallTechStories = Get::byCategoryOrderBy('science', 'published_date DESC', 2);
        $smallCultureStories = Get::byCategoryOrderBy('politics', 'published_date DESC', 2);
...
<div class="container">
        ...
        <div class="leftSide width-8">
            <div class="width-8">
                ...
                <div class="author width-8">
                    <h1><?= $author->first_name?> <?= $author->last_name ?> - Journalist</h1>
                    <h5>You can visit my personal website at <strong><a href="#"><?= $author->link ?></a></strong></h5>
                </div>
                
                <div class="bio width-6">
                    <p><?= $author->bio ?></p>
                </div>
